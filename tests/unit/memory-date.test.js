...
describe('spokenDate', () => {
  ...
  it('buckets time of day', () => {
    expect(spokenDate(1782950400, 0)).toContain('in the small hours'); // 2026-07-02 00:00Z
    expect(spokenDate(1782993600, 0)).toContain('in the afternoon');   // 2026-07-02 12:00Z
    expect(spokenDate(1783015200, 0)).toContain('in the evening');     // 2026-07-02 18:00Z
  });
});
